...
Serializer<AuthResource> _$authResourceSerializer =
    new _$AuthResourceSerializer();

class _$AuthResourceSerializer implements StructuredSerializer<AuthResource> {
  @override
  final Iterable<Type> types = const [AuthResource, _$AuthResource];
  @override
  final String wireName = 'AuthResource';

  @override
  Iterable<Object> serialize(Serializers serializers, AuthResource object,
  ...
  @override
  AuthResource deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new AuthResourceBuilder();
...
class _$AuthResource extends AuthResource {
  @override
  final int rc;
  @override
  ...
  factory _$AuthResource([void Function(AuthResourceBuilder) updates]) =>
      (new AuthResourceBuilder()..update(updates)).build();
  ...
  @override
  AuthResource rebuild(void Function(AuthResourceBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AuthResourceBuilder toBuilder() => new AuthResourceBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AuthResource &&
        rc == other.rc &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('AuthResource')
          ..add('rc', rc)
          ..add('message', message)
...
class AuthResourceBuilder
    implements Builder<AuthResource, AuthResourceBuilder> {
  _$AuthResource _$v;
  ...
  AuthResourceBuilder get _$this {
    if (_$v != null) {
      _rc = _$v.rc;
  ...
  @override
  void replace(AuthResource other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$AuthResource;
  }

  @override
  void update(void Function(AuthResourceBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$AuthResource build() {
    _$AuthResource _$result;
    try {
      _$result = _$v ??
          new _$AuthResource._(
              rc: rc,
              message: message,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'AuthResource', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
